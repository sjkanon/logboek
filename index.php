...
<header>
<img src="../images/AVHTECH-logo.png" alt="Logo AVHTECH" class="AVHTECH">
<img src="../images/RomTlogo.png" alt="Logo Ronde om Texel 2023" class="romt">
...
<h4> Please login in to get our system ready</h4>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't remember your password? <a href="reset-password.php">Reset now</a>.</p>
        </form>
    </div>
</body>
</html>
